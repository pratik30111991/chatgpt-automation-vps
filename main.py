...
SERVICE_ACCOUNT_FILE = "service_account.json"  # Upload this in Render too
...
async def get_chatgpt_titles(keyword, email, password):
    ...
    await page.waitForTimeout(20000)  # adjust based on generation time
